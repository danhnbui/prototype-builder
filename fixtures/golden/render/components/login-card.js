return '<div class="card" style="width:var(--w-card);max-width:100%;box-sizing:border-box;padding:var(--space-6);background:var(--surface);border:var(--border-width) solid var(--border);border-radius:var(--radius-medium);box-shadow:var(--shadow-md);display:flex;flex-direction:column;gap:var(--space-3)">'
  + '<h2 class="card__title" style="font-family:var(--font-heading);font-size:var(--text-lg);font-weight:600;margin:0">Sign in</h2>'
  + '<p class="card__sub" style="font-family:var(--font-body);font-size:var(--text-sm);color:var(--text-active-secondary);margin:0">Welcome back — enter your details to continue.</p>'
  + '</div>';
